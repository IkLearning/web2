        ...
        return(
            <div className="create">
                <div className="create__head">
                    <div className="create__title"><img src="http://www.azyrusthemes.com/forum2/fonts/icons/main/New_Topic.svg" alt="New topic"/>Create New Thread</div>
                ...
                <div className="create__section create__textarea">
                    ...
                    <textarea className="form-control" id="description">Adding amazing books to your summer reading list can be as simple as signing up htmlFor the BuzzFeed Books newsletter! You'll get a review of a new book you might love every Wednesday, plus much more twice a week: great jokes and quizzes, wonderful lists, powerful essays, all the Harry Potter and YA buzz you can handle, and of course, even more book recommendations. So make some space in your beach bag now — because you're going to have a lot to read this summer.</textarea>
                </div>
                <div className="create__section">
