        ...
        return(
            <div className="topics">
                <div className="topics__heading">
                    <h2 className="topics__heading-title">Which movie have you watched most recently?</h2>
                        ...
                        <div className="topic">
                            <div className="topic__head">
                                ...
                                <div className="topic__caption">
                                    ...
                                    <div className="topic__date"><i className="icon-Watch_Later"></i>06 May, 2017</div>
                                </div>
                            </div>
